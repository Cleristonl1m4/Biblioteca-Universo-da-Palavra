...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $sql = "INSERT INTO Alunos (nome,cpf,telefone,cep,estado,cidade,endereco,bairro,email) VALUES (?,?,?,?,?,?,?,?,?);";
    ...
    <div class="w3-container">
        <h2 class="w3-margin-top"><strong>Cadastro de Alunos</strong></h2>
        <form id="formaCliente" class='w3-container w3-card-2 w3-margin-top' action="pageAlunosCadastro.php" method="post">
    ...
    <?php include("pagelistarAlunos.php") ?>
</body>
