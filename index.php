        ...
        <form method="GET" action="buscar.php">
            <div class="w3-row">
                <div class="w3-col s9 m10">
                    <input class="w3-input w3-border-0" type="text" name="q" placeholder="🔍 Buscar livros, autores, editoras...">
                </div>
...
<div class="w3-container w3-padding-32">
    <div class="w3-center w3-padding-16">
        ...
        <div class="w3-border-top w3-border-green" style="width:80px; margin:10px auto; border-width:3px !important;"></div>
    </div>
                ...
                <div class="w3-col l4 m6 s12 w3-margin-bottom">
                    <div class="w3-card-4 w3-white w3-round-large w3-hover-shadow">
                        <div class="w3-container w3-center w3-padding-32">
                            ...
                            <?php else: ?>
                                <div class="w3-display-container w3-light-grey w3-round" style="width:150px; height:200px; margin:0 auto;">
...
<div class="w3-container w3-light-grey w3-padding-64">
    <div class="w3-center w3-padding-16">
        ...
        <div class="w3-border-top w3-border-brown" style="width:80px; margin:10px auto; border-width:3px !important;"></div>
    </div>
